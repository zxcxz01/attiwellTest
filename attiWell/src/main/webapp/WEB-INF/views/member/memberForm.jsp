				...
				<form action="${contextPath}/member/addMember.do" method="post"
					...
					<div class="row">
						<div class="col-md-3 mb-3">
							<label for="">전화 번호<span style="color: red"> *</span></label> <select
								class="form-control" id="tel1" name="tel1" required>
							...
							<div class="invalid-feedback">전화번호를 선택하세요.</div>
						</div>
						<div>
							<div>&nbsp;</div>
							<span>&nbsp;_&nbsp;</span>
					...
					<div class="row">
						<div class="col-md-3 mb-3">
							<label for="phoneCountryCode">핸드폰 번호<span
								style="color: red"> *</span></label> <select class="form-control"
								id="phoneNumber1" name="phoneNumber1" required>
								<option value="" disabled selected>선택</option>
								<option value="010">010</option>
								<option value="016">016</option>
								<option value="017">017</option>
					...
					<div class="row">
						<div class="col-md-4 mb-3">
							...
							<div class="input-group">
								<input type="text" class="form-control" maxlength="13"
									id="emailSuffix" name="email1" placeholder="도메인"
									pattern="/^[\w\.-]" required>
						...
						<div class="col-md-8 mb-3">
							...
							<div class="input-group">
								<input type="text" pattern="/^[a-zA-Z0-9.-]+\.[a-zA-Z]{2,4}$/"
									id="email2" class="form-control" placeholder="이메일 직접 입력">
								<select id="emailDomain" class="form-control"
									onChange="updateEmail2(this)" required>
									<option value="" disabled selected>선택</option>
					...
					<div class="row">
						<div class="col-md-12">
							<label for="detailAddress">나머지 주소</label> <input type="text"
								name="namujiAddress" class="form-control" id="detailAddress"
    ...
    function updateSmsStatus() {
     ...
     function updateEmail2(select) {
        ...
        if (selectedValue === 'non') {
            email2Input.value = ''; // 입력 필드를 초기화
            email2Input.disabled = false; // 입력 필드를 활성화
        } else {
            email2Input.value = selectedValue;
            email2Input.disabled = true; // 입력 필드를 비활성화
        }
    }
  </script>
