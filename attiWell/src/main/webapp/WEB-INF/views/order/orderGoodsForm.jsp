...
.hr_black {
	border: 0.5px solid black; /* 원하는 색상으로 변경하세요. */
}
...
#popup_order_detail {
	...
	border: 2px solid #cccccc; /* 경계선 색상을 연한 회색으로 변경 */
	box-shadow: 0px 0px 20px 5px rgba(0, 0, 0, 0.5); /* 그림자 범위를 넓게 조절 */
}
...
<body>
	<div class="input-form ">
		<form name="form_order">
			...
			<h3 class="mb-4" style="font-size: 30px; color: #660033">주문 / 결제</h3>
			...
			<DIV>
				...
				<div>
					<table>
						<tbody>
							<tr>
								<td><label class="lableBox">이름</label></td>
								<td><input class="inputBox" type="text"
									value="${orderer.member_name}" size="15" required /></td>
							</tr>
							<tr>
								<td><label class="lableBox">핸드폰</label></td>
								<td><input class="inputBox" type="text"
									value="${orderer.hp1}-${orderer.hp2}-${orderer.hp3}" size="15"
									required /></td>
							</tr>
							<tr>
								<td><label class="lableBox">이메일</label></td>
								<td><input class="inputBox" type="text"
									value="${orderer.email1}@${orderer.email2}" size="15" required />
								</td>
							</tr>
						</tbody>
					</table>
				...
				<DIV>
					...
					<table>
						<tbody>
							<tr>
								<td><label class="lableBox">배송방법</label></td>
							...
							<tr>
								<td><label class="lableBox">배송지 선택</label></td>
							...
							<tr>
								<td><label class="lableBox">받으실 분</label></td>
								<td><input class="inputBox" id="receiver_name"
									name="receiver_name" type="text" size="40"
									value="${orderer.member_name }" /> <input type="hidden"
									id="h_orderer_name" name="h_orderer_name"
									value="${orderer.member_name }" /> <input type="hidden"
							...
							<tr>
								...
								</select> <input class="inputBox_select" type="text" id="tel2"
									name="tel2" value="${orderer.tel2 }"> <input
									class="inputBox_select" type="text" id="tel3" name="tel3"
									value="${orderer.tel3 }"></td>
							...
							<tr>
								...
								<td style="margin-top: 30px">&nbsp;<br> <input
									...
									<p>
										...
										<input class="inputBox" type="text" id="roadAddress"
											name="roadAddress" size="50" value="${orderer.roadAddress }"
											placeholder="지번 주소를 입력하세요." /><br> <input
											class="inputBox" type="text" id="jibunAddress"
											name="jibunAddress" size="50"
											value="${orderer.jibunAddress }" placeholder="도로명 주소를 입력하세요." /><br>
										<input class="inputBox" type="text" id="namujiAddress"
											name="namujiAddress" size="50"
											value="${orderer.namujiAddress }" placeholder="상세 주소를 입력하세요." />
							...
							<tr>
								<td><label class="lableBox">배송 메시지</label></td>
								<td><input class="inputBox" id="delivery_message"
									name="delivery_message" type="text" size="50"
									placeholder="택배 기사님께 전달할 메시지를 남겨주세요." /></td>
							</tr>
							<tr>
								<td><label class="lableBox">선물 포장</label></td>
				...
				<DIV class="detail_table">
						...
						<tbody align=center>
							...
							<tr>
								<c:forEach var="item" items="${myOrderList }">
									<td class="goods_image goods_buttom"><a
									...
									<!-- 주문금액 -->
									<td class="goods_buttom">${item.goods_sales_price}원</td>


									<!-- 주문 금액 합계 -->
									<td class="goods_buttom">${final_total_order_price + item.goods_sales_price * item.order_goods_qty}원
					...
					<table class="list_view"
						style="background: rgb(230, 230, 230); width: 700px;">
						<tbody>
				...
				<div>
						...
						<tbody>
							<tr style="height: 40px;">
								<td><input type="radio" id="pay_method" name="pay_method"
									...
									&nbsp;신용카드 &nbsp;&nbsp;&nbsp;</td>
								<td><input type="radio" id="pay_method" name="pay_method"
									value="제휴 신용카드"> &nbsp;제휴 신용카드 &nbsp;&nbsp;&nbsp;</td>
								<td><input type="radio" id="pay_method" name="pay_method"
									value="실시간 계좌이체"> &nbsp;실시간 계좌이체 &nbsp;&nbsp;&nbsp;</td>
								<td><input type="radio" id="pay_method" name="pay_method"
									value="무통장 입금"> &nbsp;무통장 입금 &nbsp;&nbsp;&nbsp;</td>
							</tr>
							...
							<tr style="height: 40px;">
								<td><input type="radio" id="pay_method" name="pay_method"
									...
									&nbsp;&nbsp;&nbsp;</td>
								<td><input type="radio" id="pay_method" name="pay_method"
									value="페이나우(간편결제)"> &nbsp;페이나우 &nbsp;&nbsp;&nbsp;</td>
								<td><input type="radio" id="pay_method" name="pay_method"
									value="카카오페이(간편결제)"> &nbsp;<img width="90" alt=""
									src="${contextPath}/resources/image/kakaoPay.png">
									&nbsp;&nbsp;&nbsp;</td>
								<td><input type="radio" id="pay_method" name="pay_method"
									value="페이코(간편결제)"> &nbsp;<img width="80" alt=""
									src="${contextPath}/resources/image/payco.png">
									&nbsp;&nbsp;&nbsp;</td>
							</tr>
					...
					<table>
						<tbody>
							<tr id="tr_pay_card">
								<td><strong>카드 선택 &nbsp;:&nbsp;</strong> <select
									class="inputBox_select" id="card_com_name" name="card_com_name">
								...
								<td><strong>할부 기간 &nbsp;:&nbsp;<strong> <select
											class="inputBox_select" id="card_pay_month"
											name="card_pay_month">
							...
							<tr>
								...
								<td colspan="2" id="tr_pay_phone" style="visibility: hidden">
									<strong>휴대폰 번호 입력 &nbsp;:&nbsp;<strong> <select
											class="inputBox_select" id="pay_order_tel1"
											name="pay_order_tel1">
												<option value="010" selected>&nbsp;010</option>
												<option value="011">&nbsp;011</option>
												<option value="016">&nbsp;016</option>
												...
												<option value="018">&nbsp;018</option>
												<option value="019">&nbsp;019</option>
										</select> <!-- <input class="inputBox_select" type="text" size="5" value=""  id="pay_order_tel1" name="pay_order_tel1" required/> -->
											<input class="inputBox_select" type="text" size="5" value=""
											id="pay_order_tel2" name="pay_order_tel2" required /> <input
											class="inputBox_select" type="text" size="5" value=""
											id="pay_order_tel3" name="pay_order_tel3" required />
								</td>
							</tr>
	...
	<center>
		<br> <br> <a href="javascript:fn_show_order_detail();">
			<input class="myButton" style="width: 500px" type="button"
			value="결제하기"> <%--       <img width="125" alt="" src="${contextPath}/resources/image/btn_gulje.jpg"> --%>
		</a> <a href="${contextPath}/main/main.do"> <input class="myButton"
			style="background-color: rgb(200, 200, 200); width: 190px"
			type="button" value="쇼핑 계속하기"> <%--          <img width="75" alt="" src="${contextPath}/resources/image/btn_shoping_continue.jpg"> --%>
		</a>
	</center>
		...
		<div id="popup_order_detail">
			...
			<div>
				...
				<center>
					<table class="order_table">
						<tbody align=left>
							...
							<tr>
								...
								<td>
									<p class="expanding-box" id="p_order_goods_id">주문번호</p>
								</td>
							</tr>
							<tr>
								<td width=200px>주문상품명 :</td>
								<td>
									<p class="expanding-box" id="p_order_goods_title">주문 상품명</p>
								</td>
							</tr>
							<tr>
								<td width=200px>주문상품개수 :</td>
								<td>
									<p class="expanding-box" id="p_total_order_goods_qty">주문
										상품개수</p>
								</td>
							</tr>
							<tr>
								...
								<td>
									<p class="expanding-box" id="p_total_order_goods_price">주문금액합계</p>
								</td>
							</tr>
							<tr>
								<td width=200px>주문자 :</td>
								<td>
									<p class="expanding-box" id="p_orderer_name">주문자 이름</p>
								</td>
							</tr>
							<tr>
								<td width=200px>받는사람 :</td>
								<td>
									<p class="expanding-box" id="p_receiver_name">받는사람이름</p>
								</td>
							</tr>
							<tr>
								<td width=200px>배송방법 :</td>
								<td>
									<p class="expanding-box" id="p_delivery_method">배송방법</p>
								</td>
							</tr>
							<tr>
								<td width=200px>받는사람 휴대폰번호 :</td>
								<td>
									<p class="expanding-box" id="p_receiver_hp_num"></p>
								</td>
							</tr>
							<tr>
								<td width=200px>받는사람 유선번화번호 :</td>
								<td>
									<p class="expanding-box" id="p_receiver_tel_num">배송방법</p>
								</td>
							</tr>
							<tr>
								<td width=200px>배송주소 :</td>
								<td align=left>
									<p class="expanding-box" id="p_delivery_address">배송주소</p>
								</td>
							</tr>
							<tr>
								<td width=200px>배송메시지 :</td>
								<td align=left>
									<p class="expanding-box" id="p_delivery_message">배송메시지</p>
								</td>
							</tr>
							<tr>
								<td width=200px>선물포장 여부 :</td>
								<td align=left>
									<p class="expanding-box" id="p_gift_wrapping">선물포장</p>
								</td>
							</tr>
							<tr>
								<td width=200px>결제방법 :</td>
								<td align=left>
									<p class="expanding-box" id="p_pay_method">결제방법</p>
								</td>
							</tr>
					...
					<br> <input class="myButton" name="btn_process_pay_order"
						type="button" onClick="fn_process_pay_order()" value="최종결제하기">
					<a href="javascript:"
						onClick="javascript:imagePopup('close', '.layer01');"> <input
						class="myButton2" name="btn_process_pay_order" type="button"
						value="닫기"></a>
				</center>
			</div>
		</div>
